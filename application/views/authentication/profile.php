			...
			<div class="box-body box-profile">
				...
				<ul class="list-group list-group-unbordered">
					<li class="list-group-item" style="text-align:center">
						<b>Tanggal Daftar</b><br><a><?= tgl_lengkap($userdata->tanggal_daftar);?></a>
					</li>
					<li class="list-group-item" style="text-align:center">
				...
				<div class="active tab-pane" id="settings">
					<form class="form-horizontal" action="<?php echo base_url('auth/updateProfile') ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control" placeholder="Telp" name="handphone" value="<?= $userdata->handphone; ?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Instansi</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="Asal" name="asal" value="<?= $userdata->asal; ?>">
							</div>
						</div>
						<div class="form-group">
