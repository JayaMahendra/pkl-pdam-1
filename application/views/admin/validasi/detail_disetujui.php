		...
		<div>
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-horizontal ng-pristine ng-valid" action="<?= base_url('admin/validasi/update_disetujui/' . $pengajuan->pengajuan_id) ?>" method="post" enctype="multipart/form-data">
						...
						<!-- <button class="btn btn-primary" type="submit">Update</button> -->
						<button type="submit" class="btn btn-success" onclick="return ConfirmSetuju()">Submit</button>
